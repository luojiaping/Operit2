...
function addresses. Platform hosts keep the loaded library mapped until process
exit so outstanding FFI calls and VM finalizers always reference live code.
