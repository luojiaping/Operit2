...
/** Renders a streamed plan with plan preview and implementation handoff. */
function Screen(ctx) {
    ...
    /** Starts implementation for the rendered, confirmed plan. */
    const handleStart = async () => {
        ...
        const result = await (0, plan_mode_execution_js_1.startPlanImplementation)(planContent, chatId);
    ...
    return ctx.UI.Column({
        ...
        onLoad: async () => {
            ...
            const started = await (0, plan_mode_execution_js_1.isPlanImplementationStarted)(planContent, chatId);
            if (started) {
                startedState.set(true);
            }
        },
