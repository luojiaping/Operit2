...
/** Sends confirmed plan clarification answers to the chat that rendered the UI. */
async function submitPlanaskAnswers(message, chatId) {
    const text = (0, plan_mode_i18n_js_1.resolvePlanModeI18n)();
    try {
        return await ToolPkg.ipc.call(exports.PLAN_MODE_SUBMIT_ANSWERS_IPC_CHANNEL, { message, chatId });
    }
    catch (error) {
