...
/** Converts a supported tool error value to user-visible text. */
...
/** Completes the tool call with the current workspace plan content. */
...
/** Deletes the current workspace plan after implementation completes. */
