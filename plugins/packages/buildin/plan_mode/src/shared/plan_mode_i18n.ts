export type PlanModeI18n = {
  ...
  commandChatViewMissing: string;
  commandStatusEnabled: string;
  commandStatusDisabled: string;
...
const ZH_CN: PlanModeI18n = {
  ...
  commandChatViewMissing: "当前没有可用的聊天视图，无法处理计划模式命令。",
  commandStatusEnabled: "计划模式：已开启",
  commandStatusDisabled: "计划模式：已关闭",
  commandEnabled: "计划模式已开启。",
  commandDisabled: "计划模式已关闭。",
...
const EN_US: PlanModeI18n = {
  ...
  commandChatViewMissing: "No active chat view is available for the plan mode command.",
  commandStatusEnabled: "Plan mode: enabled",
  commandStatusDisabled: "Plan mode: disabled",
  commandEnabled: "Plan mode enabled.",
  commandDisabled: "Plan mode disabled.",
...
/** Determines whether plan-mode strings should use English. */
...
/** Resolves the localized plan-mode copy for the current language choice. */
